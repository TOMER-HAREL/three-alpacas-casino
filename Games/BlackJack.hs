module Games.BlackJack where
  ...
  testListBJ = T.TestList [testCreateEmptyDeck, testDrawCardFromDeck, {-testBJperformMove,-} testBJstatesAvailable, testBJstatesAvailable2, testBJstatesAvailable3, testBJstatesAvailable4]
